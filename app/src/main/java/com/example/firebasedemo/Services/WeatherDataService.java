...
import static com.example.firebasedemo.Constants.Constants.QUERY_FOR_SPECIFIC_FORECAST;
...
public class WeatherDataService {
    ...
    public void getForecastSpecific(String Data, WeatherAPICallback weatherAPICallback){
        String url = QUERY_FOR_SPECIFIC_FORECAST + "q=" + Data + "&appid=" + API_KEY;
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, null, new Response.Listener<JSONObject>() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                weatherAPICallback.onError("Something's Wrong" + error);
            }
        });
        MySingleton.getInstance(context).addToRequestQueue(request);
    }
