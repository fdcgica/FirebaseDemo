...
public class ForecastsFragment extends Fragment  {
    ...
    private static String apiKey = "895284fb2d2c50a520ea537456963d9c";
    private static String wUrl="https://api.openweathermap.org/data/2.5/weather";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mLat = view.findViewById(R.id.lat_txt);
